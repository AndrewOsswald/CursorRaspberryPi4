...
| DIO1     | 22         | 15                           | 12 (DIO1)    | —            | Grey (A)   |
| DIO1     | 6          | 31                           | —            | 12 (DIO1)    | White (B)  |
| RF_SW    | 23         | 16                           | 1 (RF_SW)    | —            | Grey (A)   |
| RF_SW    | 12         | 32                           | —            | 1 (RF_SW)    | White (B)  |
...
| **DIO1**              | DIO1 / IRQ   | Module A: Pi pin 15 (Grey). Module B: Pi pin 31 (White).               |
| **RF_SW**             | RF switch    | Module A: Pi pin 16 (Grey). Module B: Pi pin 32 (White).             |
...
| **Blue**          | Module A — NSS, RST, BUSY (and optionally DIO1, RF_SW) |
| **Grey**          | Module A — DIO1, RF_SW (as built)                        |
| **Violet/Purple** | Module B — NSS, RST, BUSY (and optionally DIO1, RF_SW)   |
...
*As built: a breadboard was used for all connections (shared GND rail, jumpers to modules). Module A DIO1/RF_SW used grey wire; Module B DIO1/RF_SW used white wire.*
...
| 14  | GND               | Black  | 15  | GPIO 22 (A DIO1) | Grey   |
| 16  | GPIO 23 (A RF_SW) | Grey   | 17  | 3.3 V (B)        | Red    |
